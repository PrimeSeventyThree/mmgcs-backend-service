 ...
 * -----
 * Last Modified: Sunday, 19th April 2026 2:48:45 pm
...
export function addUser(user: UserRecord): void {
    console.debug(`Adding user: ${user.username}`);
 ...
 * @return {UserRecord} The user if found, otherwise undefined.
 */
export function getUserByName(username: string): UserRecord {
